						...
						<table id="chaxun_table" width="100%" border="1" align="center" cellpadding="4"
							...
							<tr>
								...
								<td height="25" width="14%" align="left" style="border:0px"><input
									id="title" name="title" type="text" value=${title }></input>
								</td>
								<td height="25" width="10%" align="right" style="border:0px">用章类型：</td>
								<td height="25" width="14%" align="left" style="border:0px">
									<s:select id="type" name="type" headerKey="-1"
										...
										listValue="dataname" theme="simple" value="type" /></td>
					<!-- 			<td height="25" width="10%" align="right" style="border:0px">发布部门：</td>
							...
							<tr>
								<td align="right" width="10%">
									<div style="padding-top:4px"><s:if test="readonly==true"></s:if><s:else><a href="addChapterIndex.action"><img src="<%=request.getContextPath()%>/framework/img/add.png" border="0" /></a></s:else></div>
								</td>
								<td align="left" colspan="5">
									<div style="padding-top:4px">
										<a href="javascript:;" onclick="doSearchByChapter();"><img src="<%=request.getContextPath()%>/framework/img/search.png" border="0" /> </a>
									</div>		
								</td>
							</tr>
						</table>
							...
							<tbody>
								<s:if test="mgs!=null && !mgs.isEmpty()">
									<s:iterator value="mgs">
										<tr>
											...
											<a
												href="rulesDetail.action?messageId=${MESSAGE_ID }&type=${TYPE}&dept=${DEPT}"><img
													src="<%=request.getContextPath()%>/framework/img/view.png"
													border="0" style="vertical-align:middle;" />查看</a>
											</s:if><s:else><s:if test="STATUS==0">
											<a
												href="modifyChapterIndex.action?messageId=${MESSAGE_ID }"><img
													src="<%=request.getContextPath()%>/framework/img/modify.png"
													border="0" style="vertical-align:middle;" />修改</a></s:if> <a
												href="chapterDetail.action?messageId=${MESSAGE_ID }&type=${TYPE}&dept=${DEPT}"><img
													src="<%=request.getContextPath()%>/framework/img/view.png"
													border="0" style="vertical-align:middle;" />查看</a> <a
												href="javascript:;" onclick="delChapter('${MESSAGE_ID }');"><img
								...
								<tr height="32px">
									<td height="20" align="right" colspan="5">
										<!--分页开始--> <s:include value="/framework/include/chapter.jsp" />
										<!--分页结束--></td>
								</tr>
							</tbody>
						</table></td>
