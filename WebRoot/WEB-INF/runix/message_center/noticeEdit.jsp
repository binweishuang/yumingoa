       ...
       <tr>
        <td>
	        <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td height="25" background="<%=SystemConfig.FRAMEWORK_PATH%>/img/bg-tit.jpg">&nbsp;&nbsp;当前位置： 公共信息 &gt;&gt; <span class="STYLE1">通知管理</span>&nbsp;&gt;&gt; <span class="STYLE1">修改通知</span></td>
					  </tr>
					</table>		  
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">修改通知</span></td>
          </tr>
          <tr>
            ...
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">通知类型： </td>
            <td width="38%" height="20" bgcolor="#FFFFFF">
          ...
          <tr>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">起始日期： </td>
            <td width="38%" height="20" bgcolor="#FFFFFF">
            	<input name="mage.starttime" id="start" type="text"
								value="<s:date name='mage.starttime' format='yyyy-MM-dd'/>"
            ...
            <td width="38%" height="20" bgcolor="#FFFFFF">
            	<input name="mage.endtime" id="endDate" type="text"
								value="<s:date name='mage.endtime' format='yyyy-MM-dd'/>"
           ...
           <tr>
            ...
            <td width="38%" height="20" bgcolor="#FFFFFF" colspan="3">
            	<s:select id="scope" name="mage.scope" headerKey="-1" headerValue="--所有部门--" list="depts" listKey="deptId" listValue="deptname" theme="simple" value="mage.scope" />
            	<span style="margin-left:10px;"></span>
            </td>
          </tr>         
          <tr>
            <td width="12%"  height="20" align="right" bgcolor="#f8f8f8">通知内容： </td>
          ...
          <tr>
            <td height="20" colspan="4" bgcolor="#FFFFFF"><div align="center">
            	<input type="button" name="release" value="发布"  onclick="releaseNotice();" class="buttons"/>
                <input type="button" name="save" value="保存"  onclick="modifyNotice();" class="buttons"/>
