       ...
       <tr>
        <td>
	        <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td height="25" background="<%=SystemConfig.FRAMEWORK_PATH%>/img/bg-tit.jpg">&nbsp;&nbsp;当前位置： 公共信息 &gt;&gt; <span class="STYLE1">规章制度</span>&nbsp;&gt;&gt; <span class="STYLE1">新建规章制度</span></td>
					  </tr>
					</table>		  
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">新建规章制度</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="38% height="20" bgcolor="#FFFFFF">
            	<s:select id="type" name="mage.type" headerKey="-1"
										...
										listValue="dataname" theme="simple" onblur="checkMesg('规章制度类型','RULES');"/>
				<span style="margin-left:10px;"></span>
            </td>
          ...
          <tr>
            <td height="20" colspan="4" bgcolor="#FFFFFF"><div align="center">
                <input type="button" name="release" value="发布"  onclick="doRulesRelease();" class="buttons"/>
                <input type="button" name="save" value="保存"  onclick="doRulesCheck();" class="buttons"/>
