					...
					<td>
						...
						<table id="chaxun_table" width="100%" border="1" align="center" cellpadding="4"
							...
							<tr>
								...
								<td height="25" width="10%" align="right" style="border:0px">规章类型：</td>
					...
					<!-- 			<td height="25" width="10%" align="right" style="border:0px">发布部门：</td>
							...
							<tr>
								<td align="right" width="10%">
									<div style="padding-top:4px"><s:if test="readonly==true"></s:if><s:else><a href="addRulesIndex.action"><img src="<%=request.getContextPath()%>/framework/img/add.png" border="0" /></a></s:else></div>
								</td>
								<td align="left" colspan="5">
									<div style="padding-top:4px">
										<a href="javascript:;" onclick="doSearchByRules();"><img src="<%=request.getContextPath()%>/framework/img/search.png" border="0" /> </a>
									</div>		
								</td>
							</tr>
						</table>
							...
							<tbody>
								<s:if test="mgs!=null && !mgs.isEmpty()">
									<s:iterator value="mgs">
										<tr>
											...
											<a
												href="modifyRulesIndex.action?messageId=${MESSAGE_ID }"><img
												...
												href="javascript:;" onclick="delRules('${MESSAGE_ID }');"><img
								...
								<tr height="32px">
									<td height="20" align="right" colspan="5">
										<!--分页开始--> <s:include value="/framework/include/rules.jsp" />
										<!--分页结束--></td>
								</tr>
							</tbody>
						</table></td>
