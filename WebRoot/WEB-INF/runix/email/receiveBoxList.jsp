...
<head>
	...
	<script>
		...
		function doObject(id){
			document.getElementById('receiveBoxForm').action=id+".action";
			document.getElementById('receiveBoxForm').submit();
		}
		

		function dodelete(id){
			parent.conferm(id,"receive");
		}
		
		function doview(id){
				document.getElementById('receiveBoxForm').action="view.action?emailId_q="+id;
				document.getElementById('receiveBoxForm').submit();
		}
	</script>
	</head>
	<body >
	<s:form action="emailAction" id="receiveBoxForm" theme="simple"  method="post" target="_self">
