...
<head>
	...
	function changeIframe(flag,classNa){
		...
		if(flag=='1'){
			document.getElementById("iframone").src='<%=request.getContextPath() %>/usingEquip/query.action';
		}else if(flag=='2'){
			document.getElementById("iframone").src='<%=request.getContextPath() %>/equipment/query.action';
		}
	}
	</script>
	</head>
            ...
            <!--右侧内容-->
			  <div   style="width:99%; margin:0 auto; background-color:#fff;">
			       ...
			       <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td height="25" background="<%=SystemConfig.FRAMEWORK_PATH%>/img/bg-tit.jpg">&nbsp;&nbsp;当前位置： 行政办公 &gt;&gt; <span class="STYLE1">设备管理</span></td>
					  </tr>
					</table>
					...
					<table id="tab_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#f8de91" style="border-collapse:collapse;">
						...
						<tr>
							...
							<div id="con">
								<ul id="tags">
								  <li class="selectTag" id="man_nav_1" onclick="changeIframe('1','man_nav_1');"><A  href="javascript:void(0)">领用管理</A></li>
								  <li onclick="changeIframe('2','man_nav_2');" id="man_nav_2" class="bg_image"><A  href="javascript:void(0)">设备管理</A></li>
								</ul>
								<div id="tagContent">
									 <iframe src="<%=request.getContextPath() %>/usingEquip/query.action"  id="iframone" width="100%" frameborder=0 align="right" height="635px" scrolling="auto" ></iframe>	 
								</div>
							</div>
							<!--tab over-->
						  </td> 
