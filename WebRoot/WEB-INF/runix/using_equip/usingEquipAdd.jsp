...
<head>
	...
	<script>
		function doCheck(){
			...
			document.getElementById('usingEquipAddForm').action="insert.action";
	...
	<s:form action="usingEquipAddAction" id="usingEquipAddForm" theme="simple"  method="post">
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">添加领用</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><input name="storagenum"  id="storagenum" type="text" value="" size="20" readonly/></td>
            <td height="20" align="right" bgcolor="#f8f8f8">领用数量：</td>
            <td height="20" bgcolor="#FFFFFF"><input name="applynum" id="applynum" type="text" value="" size="20" /></td>
          </tr>
		  <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">使用时间：</td>
            <td height="20" bgcolor="#FFFFFF" colspan="3"><input name="starttime" id="starttime" type="text" value="" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,maxDate:'#F{$dp.$D(\'endtime\')||\'2020-01-01\'}'})" size="20"  class="Wdate"/> 至 <input name="endtime" id="endtime" type="text" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,minDate:'#F{$dp.$D(\'starttime\')}',maxDate:'2020-10-01'})" value="" size="20"  class="Wdate"/></td>          
          </tr>
		  <tr>
