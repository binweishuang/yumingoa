...
<body >
	<form action="<%=request.getContextPath() %>/survey/insert.action" method="post" id="form1">
        	...
        	<tr>
        		<td>
	        		<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td height="25" background="<%=SystemConfig.FRAMEWORK_PATH%>/img/bg-tit.jpg">&nbsp;&nbsp;当前位置： 在线交流 &gt;&gt; <span class="STYLE1">网上调查</span>&gt;&gt; <span class="STYLE1">添加调查项</span></td>
					  </tr>
					</table>		  
			        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
			          <tr>
			            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">添加调查项</span></td>
			          </tr>
			          <tr>
			            ...
			            <td width="38%" height="20" bgcolor="#FFFFFF" >
						 ...
						 <td width="12%" height="20" align="right" bgcolor="#f8f8f8">调查对象： </td>
			            <td width="38%" height="20" bgcolor="#FFFFFF" >
			            	<input type="text" id="surveypersonnames" name="peoplesname" onclick="selectPerson();" readonly="readonly"></input>
			            	<input type="hidden" name="surveyperson" id="surveypersonids" />
			            </td>
					</tr>
			          <tr>
			            <td height="20" width="12%" align="right" bgcolor="#f8f8f8">开始时间： </td>
			            <td height="20" width="38%" bgcolor="#FFFFFF">
							<input type="text" name="starttime" id="starttime" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd',vel:'smonth',realDateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endtime\')||\'2020-01-01\'}'})" class="Wdate"/>
							
						</td>
			            <td height="20" width="12%" align="right" bgcolor="#f8f8f8">终止时间： </td>
			            <td height="20" width="38%" bgcolor="#FFFFFF">
							<input type="text" name="endtime" id="endtime" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd',vel:'smonth',realDateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'starttime\')}',maxDate:'2020-10-01'})" class="Wdate"/>
			          ...
			          <tr>
			            ...
			            <td height="20" bgcolor="#FFFFFF">
				            <input type="radio" name="publicity" value="1" checked="checked" /> 公开
				            <input type="radio" name="publicity" value="0" /> 不公开
			            </td>
			            <td height="20" align="right" bgcolor="#f8f8f8">投票方式：</td>
			            <td height="20" bgcolor="#FFFFFF">
							<input type="radio" name="votingway" value="1" checked="checked" /> 记名
				            <input type="radio" name="votingway" value="0" /> 不记名
						</td>
			          </tr> 
					  <tr >										 
					...
					<table id="xinxiu_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#f8de91" style="border-collapse:collapse;">
						<tr height="32px">										 
						  ...
						  <td style="width:88%;text-align:left"><input name="content" id="content1" type="text" size="60"/></td>
						</tr>
						<tr height="32px">										 
						  <td align="right" style="width:12%"></td>
						  <td style="width:88%;text-align:left"><input name="content" id="content2" type="text" size="60"/></td>
						</tr>			
					</table>
				</td>
			</tr>
