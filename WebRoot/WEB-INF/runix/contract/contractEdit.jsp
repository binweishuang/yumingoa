...
<body >
	<form action="<%=request.getContextPath() %>/contract/update.action" method="post" id="form1">     
    <div  style="width:99%; margin:0 auto; background-color:#fff;">            
    	<input type="hidden" name="contractId_q" value="${contractId_q}" />    
    	<table width="100%" border="0" cellspacing="0" cellpadding="5">
       		<tr>
        		<td>
	        		<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td height="25" background="<%=SystemConfig.FRAMEWORK_PATH%>/img/bg-tit.jpg">&nbsp;&nbsp;当前位置： 人力资源 &gt;&gt; <span class="STYLE1">合同管理</span>&nbsp;&gt;&gt; <span class="STYLE1">修改合同</span></td>
					  </tr>
					</table>
					<s:iterator value="contractList">	  
			        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
			          <tr>
			            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">修改合同</span></td>
			          </tr>
			          <tr>
			            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">签订人： </td>
			            <td width="38%" height="20" bgcolor="#FFFFFF">${SIGNEDPERSONNAME}<input name="signedperson" type="hidden"  value="${SIGNEDPERSON}" /></td>
			            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">相关部门： </td>
			            <td width="38%" height="20" bgcolor="#FFFFFF">${DEPTNAME}<input name="department" type="hidden" value="${DEPARTMENT}" /></td>
			          </tr>
			          <tr>
			            ...
			            <td height="20" bgcolor="#FFFFFF">
			            	<select id="contracttype" name="contracttype" style="width:155px;">
			            		...
			            		<option value="${dataId}" <s:if test='CONTRACTTYPE == dataId'>selected="selected"</s:if> >${dataname}
			            		</s:iterator>
			            	</select>
			            </td>
			          ...
			          <tr>
			            ...
			            <td height="20" bgcolor="#FFFFFF"><input name="customecompany" value="${CUSTOMECOMPANY}" id="customecompany" type="text" size="20"/></td>
			            <td height="20" align="right" bgcolor="#f8f8f8">联系人：</td>
			            <td height="20" bgcolor="#FFFFFF"><input name="contact" value="${CONTACT}" id="contact" type="text" size="20"/></td>
			          </tr>         
			          <tr>
			            <td height="20" align="right" bgcolor="#f8f8f8">联系电话：</td>
			            <td height="20" bgcolor="#FFFFFF"><input name="contacttel" value="${CONTACTTEL}" id="contacttel" type="text" size="20"/></td>
			            <td height="20" align="right" bgcolor="#f8f8f8">签订日期：</td>
			            <td height="20" bgcolor="#FFFFFF">
			            	<input class="Wdate" name="signeddate" value="<s:date format='yyyy-MM-dd' name='SIGNEDDATE' />" id="signeddate" type="text" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,maxDate:'#F{$dp.$D(\'enddate\')||\'2020-01-01\'}'})" />
			            </td>
			          </tr>
					  <tr>
			            <td height="20" align="right" bgcolor="#f8f8f8">终止日期：</td>
			            <td height="20" bgcolor="#FFFFFF" colspan="3">
			            	<input class="Wdate" name="enddate" value="<s:date format='yyyy-MM-dd' name='ENDDATE' />" id="enddate" type="text" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,minDate:'#F{$dp.$D(\'signeddate\')}',maxDate:'2020-10-01'})"/>
			            </td>          
			          </tr>
					  <tr>
			            <td height="20" align="right" bgcolor="#f8f8f8">合同说明：</td>
			            <td height="260" bgcolor="#FFFFFF" colspan="3"><textarea id='details' style="width:100%;height:260px;" name='details'>${details}</textarea></td>
			          </tr>
					       
			          <tr>
			            <td height="20" colspan="4" bgcolor="#FFFFFF">
			            	<div align="center">
				                <input type="submit" class="buttons" name="save" value="修改" class="buttons"  onclick="return doCheck();"/>
