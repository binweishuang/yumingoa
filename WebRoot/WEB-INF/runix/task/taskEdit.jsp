...
<body >
          <div  style="width:99%;margin:0 auto; background-color:#fff;">
           <form id="form" name="form" action="update.action" method="post">         
           <table width="100%" border="0" cellspacing="0" cellpadding="5">
       <tr>
        <td>		  
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">修改下达任务</span></td>
          </tr>
          <tr>
		   ...
		   <tr>
            ...
            <td height="20" bgcolor="#FFFFFF">
            	<input type="text" id="reportTo" value="${reportTo}" onclick="selectReporter();"/>
            	<input type="hidden" id="reportToId" name="reportTo" value="${task.reportTo}"/>
            </td>
          </tr>
		   <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">日期： </td>
            <td height="20" bgcolor="#FFFFFF">
				<input type="text" id="startDate" name="starttime" value="<s:date format="yyyy-MM-dd HH:mm:ss" name="task.starttime"/>" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false,readOnly:true,maxDate:'#F{$dp.$D(\'endDate\')||\'2020-01-01\'}'})" class="Wdate"/>
				至
				<input type="text" id="endDate" name="endtime" value="<s:date format="yyyy-MM-dd HH:mm:ss" name="task.endtime"/>" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false,readOnly:true,minDate:'#F{$dp.$D(\'startDate\')}',maxDate:'2020-10-01'})" class="Wdate"/>
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF">
            	<input type="hidden" name="attachname" id="attachname" value="${task.attachname}"/>
            	<input type="hidden" name="attachpath" id="attachpath" value="${task.attachpath}"/>
		  ...
		  <tr>
            ...
            <td height="20" bgcolor="#FFFFFF">
            	<input type="text" id="executer" name="executer" value="${task.executer}" onclick="selectExecuter();"/>
            	<input type="hidden" id="executerid" name="executerid" value="${task.executerid}"/>
            </td>
          </tr>
		  <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">任务时限： </td>
            <td height="20" bgcolor="#FFFFFF">
            	<input type="text" id="timelimit" name="timelimit" value="${task.timelimit}"/>
            </td>
          </tr>         
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">内    容：</td>
            <td bgcolor="#FFFFFF"><textarea id='content'  style="width: 100%;height: 300px" name="content">${task.content}</textarea></td>
          </tr>
          <tr>
