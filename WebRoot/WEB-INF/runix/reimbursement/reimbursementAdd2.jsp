...
<head>
	...
	function doCheck(){
		...
		document.getElementById('reimbursementAddForm').action='insertPerson.action';
...
<body >
	...
	<s:hidden name="reimId"></s:hidden>
	<s:hidden name="titlle"></s:hidden>
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="88%" height="20" bgcolor="#FFFFFF">报销管理
			</td>
          </tr>
          <tr>
