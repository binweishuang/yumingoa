...
<head>
	...
	<script>
		function doCheck(){
			...
			document.getElementById('reimbursementAddForm').action="insert.action";
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="38%" height="20" bgcolor="#FFFFFF">
            	<input type="hidden" name="person" value="${user.name}" />${user.name}
            </td>
          </tr>
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" ><input name="titlle" id="titlle" type="text" value="" size="30"/></td>
          </tr>
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">报销总金额： </td>
            <td height="20" bgcolor="#FFFFFF"><input name="totalmoney" id="totalmoney" type="text" value="" size="20" readonly/>元</td>
            <td height="20" align="right" bgcolor="#f8f8f8">报销总单据：</td>
            <td height="20" bgcolor="#FFFFFF"><input name="totaldoc" id="totaldoc" type="text" value="" size="20" readonly/></td>
          </tr>         
		<tr>
            <td height="20" align="right" bgcolor="#f8f8f8">备    注：</td>
            <td height="50" bgcolor="#FFFFFF" colspan="3"><textarea id='remark'  style="width:50%;height:100%" name='remark'></textarea></td>
          </tr> 		  
        </table>
		...
		<table id="xinxiu_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#f8de91" style="border-collapse:collapse;">
					  ...
					  <tbody>
						<tr height="32px">										 
						  <td ></td>
						  <td ><input name="itemname" id="itemname1" type="text" size="20" /></td>				  
						  <td ><input name="time"  id="time1" type="text" value="" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd',vel:'smonth',realDateFmt:'yyyy-MM-dd'})" size="13"/></td>
						  <td ><input name="reason" id="reason1" type="text" value="" size="13"/></td>
						  <td ><input name="reimdate" id="reimdate1" type="text" value="" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd',vel:'smonth',realDateFmt:'yyyy-MM-dd'})" size="10" /></td>
						  <td ><input name="docpoll" id="docpoll1" type="text" onblur="countpoll()" value="" size="10"/></td>
						  <td ><input name="reimmoney" id="reimmoney1" type="text" onblur="countmoney()" value="" size="13"/></td>
						  <td ><input name="otheritem"  id="otheritem1" type="text" value="" size="20"/></td>
						  <td ><input name="otherpoll" id="otherpoll1" type="text" onblur="countpoll()" value="" size="10"/></td>
						  <td ><input name="othermoney" id="othermoney1" type="text" onblur="countmoney()" value="" size="13"/></td>
						</tr>			
					  </tbody>
				</table>
		</td>
