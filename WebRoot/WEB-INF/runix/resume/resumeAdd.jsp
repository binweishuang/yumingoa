...
<head>
	...
	<script>
		function doCheck(){
			...
			document.getElementById('resumeAddForm').action="insert.action";
	...
	<s:form action="resumeAddAction" id="resumeAddForm" theme="simple"  method="post">
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">添加简历信息</span></td>
          </tr>
          <tr>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">应聘者： </td>
            <td width="38%" height="20" bgcolor="#FFFFFF"><input name="name"  id="name" type="text"  value="" size="20" /></td>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">性    别： </td>
            <td width="38%" height="20" bgcolor="#FFFFFF"><input name="sex"  type="radio"  value="1"/>男
									<input name="sex" type="radio" value="2"/>女</td>
          </tr>
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">年    龄： </td>
            <td height="20" bgcolor="#FFFFFF"><input name="age" id="age" type="text"  value="" size="20"/></td>
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" colspan="3">
            	<select id="recruitmentId" name="recruitmentId" style="width:155px" onchange="changeRecruit();">
						...
						<option value="<s:property value='RECRUITMENT_ID'/>"><s:property value='TITLE'/></option>
					    </s:iterator>
				</select>
            </td>
          </tr>
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><input name="department" id="department" type="text" value="" size="20" readonly/></td>
            <td height="20" align="right" bgcolor="#f8f8f8">应聘岗位：</td>
            <td height="20" bgcolor="#FFFFFF"><input name="position" id="position" type="text" value="" size="20" readonly/></td>
          </tr>         
          <tr>
		  ...
		  <tr>           
            ...
            <td height="200" bgcolor="#FFFFFF" colspan="3"><textarea id='remark' style="width:98%;height:100%" name='remark'></textarea></td>
          </tr>
