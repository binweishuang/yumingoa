...
<body >
   <s:form action="attendAction" id="attendForm" theme="simple"  method="post" >
           <div  style="width:99%;margin-top:0 auto; background-color:#fff;">
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">签到信息</span></td>
          </tr>
          <tr>
            <td width="25%" height="20" align="right" bgcolor="#f8f8f8">现在时间： </td>
            <td width="75%" height="20" bgcolor="#FFFFFF" ><s:property value="signintime"/></td>
          </tr>
          <tr>
		  ...
		  <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">迟到状况：</td>
            <td height="20" bgcolor="#FFFFFF"><s:property value="signinMsg"/></td>
          </tr>
    <!--      <tr>
