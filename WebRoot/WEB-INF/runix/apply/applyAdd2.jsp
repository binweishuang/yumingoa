...
<head>
	...
	function doCheck(){
		...
		document.getElementById('applyAddForm').action='insertNext.action';
		document.getElementById('applyAddForm').submit();
	}
	</script>
</head>
<body >
	<s:form action="applyAddAction" id="applyAddForm" theme="simple"  method="post">
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="88%" height="20" bgcolor="#FFFFFF">请示管理
			</td>
          </tr>
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">流程线路：<s:property value="applicationId"/> </td>
            <td height="20" bgcolor="#FFFFFF">开始<s:iterator value="nodeList" id="node">-><s:property value='#node.NODENAME'/></s:iterator>
			</td>
          </tr>
          <tr>
