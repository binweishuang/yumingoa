...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function doDelete(folderId){
			if(confirm("are you sure delete ?") ){
				document.getElementsByName('folderId_q')[0].value=folderId;
				document.forms[0].action = "delete.action";
				document.forms[0].submit();
			}
		}
		function doUpdate(folderId) {
			document.getElementsByName('folderId_q')[0].value=folderId;
	...
	<body id="main_content">
		...
		<s:form action="folderAction" theme="simple">
			<s:hidden name="currentPage"/>
			<s:hidden name="folderId_q"/>
			<table class="right01" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="right02_td">
						<div class="titlebt"><s:text name="folder.query"/></div>
						<ul class="maincon">
				...
				<tr>
					...
					<td class="right05_td">
						<div id="main_content1">
							<div id="search_box">
								<div class="search_h28 pstitle"><s:text name="folder.query"/></div>
								<div class="search_h86">
									<table class="search_box_table">

										<tr>
											<td width="12%" class="search_tR"><s:text name="folder.foldername"/>:</td>
											<td width="38%"><s:textfield name="foldername" cssClass="search_txt01"/></td>
											<td width="12%" class="search_tR"><s:text name="folder.flag"/>:</td>
							...
							<div id="peos_fee">
								<table id="peos_ftable" onmouseover="overIt();" onmouseout="outIt();" onclick="clickIt();">
									...
									<tr class="theader">
										<td><s:text name="folder.folderId"/></td>
										<td><s:text name="folder.foldername"/></td>
										<td><s:text name="folder.flag"/></td>
									...
									<tr>
										...
										<td>
											<a href="#" onclick="return doDelete('<s:property value="folderId"/>');"><s:text name="user.delete"/></a>
											<a href="#" onclick="doUpdate('<s:property value="folderId"/>');"><s:text name="user.update"/></a>
										</td>
									</tr>
									</s:iterator>
								</table>
