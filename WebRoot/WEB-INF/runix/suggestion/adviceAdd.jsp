       ...
       <tr>
        <td>
	        <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="25" background="<%=SystemConfig.FRAMEWORK_PATH%>/img/bg-tit.jpg">&nbsp;&nbsp;当前位置： 在线交流 &gt;&gt; <span class="STYLE1">个人建议</span>&nbsp;&gt;&gt; <span class="STYLE1">新建建议</span></td>
				</tr>
			</table>		  
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">新建建议</span></td>
          </tr>
          <tr>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">建议主题： </td>
            <td width="38%" height="20" bgcolor="#FFFFFF">
            	<input id="title" name="suggestion.title" type="text" size="20" style="width:35%;" maxlength="50" />
            	<span style="margin-left:10px;"></span>
            </td>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">建议类型： </td>
            <td width="38%" height="20" bgcolor="#FFFFFF">
            	<s:select id="suggesttype" name="suggestion.suggesttype" list="types" headerKey="-1" headerValue="--请选择--" listKey="dataId" listValue="dataname" theme="simple"
          ...
          <tr>
            ...
            <td width="38%" height="20" bgcolor="#FFFFFF">
            	<input id="username" name="toperson" type="text"  value="" size="20" style="width:35%;" onclick="selectUser();"/>
            	<span style="margin-left:10px;"></span>	
            	<input id="userId" name="suggestion.toperson" type="hidden" />	
            </td>
          ...
          <tr>
            ...
            <td width="38%" height="20" colspan="3" bgcolor="#FFFFFF"><textarea name="suggestion.content" cols ="50" rows = "5"></textarea>
            </td>
          </tr>     
          <tr>
            <td height="20" colspan="4" bgcolor="#FFFFFF"><div align="center">
                <input type="button" name="save" value="保存"  onclick="doPersist();" class="buttons"/>
