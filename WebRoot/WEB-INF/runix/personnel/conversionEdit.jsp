...
<body >
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">修改转正信息</span></td>
          </tr>
          <tr>
          ...
          <tr>
           <td width="12%" height="20" align="right" bgcolor="#f8f8f8">概　　述： </td>
            <td width="38%" height="20" bgcolor="#FFFFFF">
            	<input type="text" id="title" name="title" size="30" value="<s:property value='title'/>"/>	
            </td>
          ...
          <tr>
            ...
            <td width="38%" height="20" colspan="3" bgcolor="#FFFFFF">
            	<textarea name="content" id="content" style="height: 300px;width: 100%"><s:property value='content'/></textarea>
            </td>
          </tr>     
          <tr>
