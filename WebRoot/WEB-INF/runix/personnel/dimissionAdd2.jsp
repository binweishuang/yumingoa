...
<head>
	...
	function doCheck(){
		...
		document.getElementById('dimissionAddForm').action='insertPerson.action';
		document.getElementById('dimissionAddForm').submit();
	}
	</script>
</head>
<body >
	<s:form action="" id="dimissionAddForm" theme="simple"  method="post">
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="88%" height="20" bgcolor="#FFFFFF">离职管理
			</td>
          </tr>
          <tr>
