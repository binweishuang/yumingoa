...
<body >
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">新建离职信息</span></td>
          </tr>
          <tr>
          ...
          <tr>
		   ...
		   <tr>
            ...
            <td bgcolor="#FFFFFF" colspan="3"><input type="text" id="title" name="title" size="30" />	</td>
          </tr> 
          <tr>
            <td width="12%"  height="20" align="right" bgcolor="#f8f8f8">离职申请内容： </td>
            <td width="38%" colspan="3" bgcolor="#FFFFFF"><textarea name="content" id="content" cols ="60" rows = "10"></textarea>
            </td>
          </tr>     
          <tr>
