       ...
       <tr>
        <td>
         <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">新建调动信息</span></td>
          </tr>
          <tr>
          ...
          <td width="12%" align="right" bgcolor="#f8f8f8">附　　件： </td>
            <td bgcolor="#FFFFFF" colspan="3">
            	...
            	<input type="hidden" name="atachpath" id="attachpath"/>
          ...
          <tr>
            ...
            <td width="38%" height="20" colspan="3" bgcolor="#FFFFFF"><textarea name="content" id="content" cols ="60" rows = "10"></textarea>
            </td>
          </tr>     
          <tr>
