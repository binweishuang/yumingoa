	...
	<script>
		function doCheck(){
			...
			if(titlle==''||titlle==null){
				Dialog.alert('请输入案卷题名！');
				return;
			}else if(titlle.length>50){
				Dialog.alert('案卷题名不能超过50个字符！');
				return;
			}
			...
			if(starttime!=''&&starttime!=null&&endtime!=''&&endtime!=null){
				if(starttime>endtime){
					Dialog.alert('起始时间不能大于终止时间！');
					return;
				}
			}
			if(status==''||status==null){
				Dialog.alert('请选择案卷状态！');
				return;
			}
			...
			document.getElementById('dossierAddForm').action="insert.action";
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="38%" height="20" bgcolor="#FFFFFF"><input name="titlle" id="titlle" type="text" value="" size="20"/></td>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">盒    号： </td>
            <td width="38%" height="20" bgcolor="#FFFFFF"><input name="boxnum" id="boxnum" type="text" value="" size="20"/></td>
          </tr>
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">案卷年度： </td>
            <td height="20" bgcolor="#FFFFFF">
				<input name="annual" id="annual" type="text" value="" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy',vel:'smonth',realDateFmt:'yyyy'})" size="20" class="Wdate"/>
			</td>
            <td height="20" align="right" bgcolor="#f8f8f8">全宗号： </td>
            <td height="20" bgcolor="#FFFFFF">
				<input name="recgroupnum" id="recgroupnum" type="text" value="" size="20"/>
			</td>
          </tr>
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">保管期限： </td>
            <td height="20" bgcolor="#FFFFFF"><input name="keeplimit" id="keeplimit" type="text" value="" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy',vel:'smonth',realDateFmt:'yyyy'})" size="20" class="Wdate"/></td>
            <td height="20" align="right" bgcolor="#f8f8f8">档案馆代号：</td>
            <td height="20" bgcolor="#FFFFFF"><input name="archivesnum" id="archivesnum" type="text" value="" size="20"/></td>
          </tr>         
          <tr>
		  ...
		  <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" >
				<select id="category" name="category" style="width:155px">
					<option value="" >--请选择--</option>
					<option value="1" >一般档案</option>
					<option value="2" >重要档案</option>
                </select>
			</td>  
		  ...
		  <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" ><input name="starttime" id="starttime" type="text" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd',vel:'smonth',realDateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endtime\')||\'2020-01-01\'}'})" value="" size="20" class="Wdate"/></td> 			
          </tr>
		  <tr>
			<td height="20" align="right" bgcolor="#f8f8f8">卷内文件终止时间：</td>
            <td height="20" bgcolor="#FFFFFF" ><input name="endtime" id="endtime" type="text" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd',vel:'smonth',realDateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'starttime\')}',maxDate:'2020-10-01'})" value="" size="20" class="Wdate"/></td> 			
          	<td height="20" align="right" bgcolor="#f8f8f8">案卷状态：</td>
            <td height="20" bgcolor="#FFFFFF" >
				<select id="status" name="status" style="width:155px">
					<option value="">--请选择--</option>
					<option value="1">拆卷</option>
					<option value="2">封卷</option>
				</select>
			</td> 
          </tr>
		  <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">备   注：</td>
            <td height="50" bgcolor="#FFFFFF" colspan="3"><textarea id='remark' style="width:98%;height:100%" name='remark'></textarea></td>
          </tr>		       
          <tr>
