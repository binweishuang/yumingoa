...
<head>
	...
	function doCheck(){
		...
		document.getElementById('netmeetingform').action="insert.action";
...
*/		   
			 var date = new Date();
			   var diag = new Dialog();
				...
				diag.Top=40;
				diag.Title = "选择参加人员";
				diag.URL = "<%=request.getContextPath() %>/selectPeople/query.action?random="+date.getTime()+"&people="+attendeename+"&peopleId="+attendee;
			        ...
			        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
			          ...
			          <tr>
			            ...
			            <td height="20" bgcolor="#FFFFFF">
							<input name="starttime" id="starttime" type="text" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,maxDate:'#F{$dp.$D(\'endtime\')||\'2020-01-01\'}'})"  value="<s:date name='starttime' format='yyyy-MM-dd HH:mm:ss'/>" size="20" class="Wdate"/> 至 <input name="endtime" id="endtime" type="text" value="<s:date name='endtime' format='yyyy-MM-dd HH:mm:ss'/>" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,minDate:'#F{$dp.$D(\'starttime\')}',maxDate:'2020-10-01'})" size="20" class="Wdate"/>
						</td>
			          </tr>
			          <tr>
