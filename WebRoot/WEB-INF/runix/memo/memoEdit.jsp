...
<body >
	<form action="<%=request.getContextPath()%>/memo/update.action" method="post" id="form1">
	<div  style="width:99%;margin:0 auto; background-color:#fff;">   
		<input type="hidden" name="memoId_q" value="${memoId_q}" />        
	        		...
	        		<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td height="25" background="<%=SystemConfig.FRAMEWORK_PATH%>/img/bg-tit.jpg">&nbsp;&nbsp;当前位置： 个人办公 &gt;&gt; <span class="STYLE1">我的便签</span>&gt;&gt; 
							<span class="STYLE1">修改便签</span>
						</td>
					  </tr>
					</table>
			        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
			          <tr>
			            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">修改便签</span></td>
			          </tr>
			          <tr>
			            <td height="20" align="right" bgcolor="#f8f8f8">上报人： </td>
			            <td height="20" bgcolor="#FFFFFF">${reportpersonname}<input type="hidden" name="reportperson" value="${reportperson}" /></td>
			          </tr> 
			          <tr>
			            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">便签标题： </td>
			            <td height="20" bgcolor="#FFFFFF"><input name="title" type="text"  value="${title}" id="title" size="20" /></td>
			          </tr>
			          <tr>
			            <td height="20" align="right" bgcolor="#f8f8f8">上报对象： </td>
			            <td height="20" bgcolor="#FFFFFF">
							<input onclick="selectUser();" value="${recievepersonname}" id="recievepersonName" type="text" size="20" />
			            	<input type="hidden" name="recieveperson" value="${recieveperson}" id="recievepersonId" />
						</td>
			          </tr> 
			          <tr>
			            <td height="20" align="right" bgcolor="#f8f8f8">有效时间： </td>
			            <td height="20" bgcolor="#FFFFFF">
							<input class="Wdate" name="starttime" type="text" id="starttime"  value="<s:date format="yyyy-MM-dd" name="starttime" />" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,maxDate:'#F{$dp.$D(\'endtime\')||\'2020-01-01\'}'})"/> 至
							<input class="Wdate" name="endtime" type="text" id="endtime" value="<s:date format="yyyy-MM-dd" name="endtime" />" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,minDate:'#F{$dp.$D(\'starttime\')}',maxDate:'2020-10-01'})" />
						</td>
			          </tr>        
			          <tr>
			            <td height="20" align="right" bgcolor="#f8f8f8">便签内容：</td>
			            <td height="20" bgcolor="#FFFFFF">
							<textarea name="content" id = "content" style="width:100%;height:150px;">${content}</textarea>
