...
<head>
	...
	<s:hidden name="flag" ></s:hidden>
		<div class="tagContent" id="tagContent3" style=" margin:0 auto; background-color:#fff;">
			...
			<table id="chaxun_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#f8de91" style="border-collapse:collapse;"  >
			  <tr>
				...
				<td height="25" width="15%" align="right" style="border:0px">休假类型：</td>
				...
				<td height="25" width="10%"  align="center" style="border:0px" ></td>
				</tr>
				<tr>
				<td height="25" width="15%" align="right" style="border:0px">起始日期：</td>
				<td height="25" width="15%" align="left" style="border:0px">
				<input name="starttime" class="Wdate"  id="starttime" type="text" value="<s:date name='starttime' format='yyyy-MM-dd'/>" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,maxDate:'#F{$dp.$D(\'endtime\')||\'2020-01-01\'}'})"/>
				</td>
				<td height="25" width="15%" align="right" style="border:0px">终止日期：</td>
				<td height="25" width="15%"align="left" style="border:0px">
				<input name="endtime" class="Wdate" id="endtime" type="text" value="<s:date name='endtime' format='yyyy-MM-dd'/>" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,minDate:'#F{$dp.$D(\'starttime\')}',maxDate:'2020-10-01'})" />
				</td>
			...
			<table id="xinxiu_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#f8de91" style="border-collapse:collapse;">
				  ...
				  <s:iterator value="workingConditionList">
					<tr height="32px">										 
					  ...
					  <td><s:property value="vacationtype"/></td>		
