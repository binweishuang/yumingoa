...
<head>
	...
	function doCheck(){
		...
		document.getElementById('biztripAddForm').action='insertPerson.action';
		document.getElementById('biztripAddForm').submit();
	}
	</script>
</head>
<body >
	<s:form action="" id="biztripAddForm" theme="simple"  method="post">
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="88%" height="20" bgcolor="#FFFFFF">出差管理
			</td>
          </tr>
          <tr>
