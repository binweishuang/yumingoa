...
<head>
	...
	function doCheck(){
		...
		document.getElementById('gooutAddForm').action='insertPerson.action';
		document.getElementById('gooutAddForm').submit();
	}
	</script>
</head>
<body >
	<s:form action="" id="gooutAddForm" theme="simple"  method="post">
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="88%" height="20" bgcolor="#FFFFFF">外出管理
			</td>
          </tr>
          <tr>
