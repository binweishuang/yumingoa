...
<head>
	...
	<s:hidden name="flag" ></s:hidden>
		<div class="tagContent" id="tagContent4" style=" margin:0 auto; background-color:#fff;">
			...
			<table id="chaxun_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#f8de91" style="border-collapse:collapse;"  >
			 <tr>
				...
				<td height="25" width="15%" align="right" style="border:0px">出差地点：</td>
				<td height="25" width="15%" align="left" style="border:0px"><input name="destination" type="text"  value="<s:property value='destination'/>"/></td>
			...
			<tr>
				<td height="25" align="right" style="border:0px">出差时间：</td>
				...
				<td height="25"  align="left" style="border:0px">
			     ...
			     <td height="25" colspan="3"  align="center" style="border:0px" ></td>
			  </tr>
			  
			  <tr>
				<td align="right" width="10%"><a href="#"  onclick="doObject('insertInit')"><img src="<%=SystemConfig.FRAMEWORK_PATH%>/img/add.png" border="0"></img></a></td>
				<td align="left" colspan="9"><a href="#" onclick="doObject('query')"><img src="<%=SystemConfig.FRAMEWORK_PATH%>/img/search.png" border="0" ></img></a></td>
			  </tr>  
			</table>
			<table id="xinxiu_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#f8de91" style="border-collapse:collapse;">
				  ...
				  <tbody> 
					...
					<tr height="32px">										 
					 ...
					 <td><s:property value="biztriplimit"/></td>
