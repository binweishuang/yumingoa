...
<head>
	...
	function doCheck(){
		...
		document.getElementById('vacationAddForm').action='insertPerson.action';
		document.getElementById('vacationAddForm').submit();
	}
	</script>
</head>
<body >
	<s:form action="" id="vacationAddForm" theme="simple"  method="post">
	<s:hidden name="flag"></s:hidden>
	<s:hidden name="title"></s:hidden>
	<s:hidden name="conditionId"></s:hidden>
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="88%" height="20" bgcolor="#FFFFFF">休假管理
			</td>
          </tr>
          <tr>
