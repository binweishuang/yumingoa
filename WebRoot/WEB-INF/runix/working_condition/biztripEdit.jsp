...
<body >
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">修改出差信息</span></td>
          </tr> 
          <tr>  
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><input name="otherpeople" id="otherpeople" type="text" size="30" value="<s:property value='otherpeople'/>" onclick="selectPeople();"/></td>
		   ...
		   <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><input name="biztriplimit"  id="biztriplimit" type="text" value="<s:property value='biztriplimit'/>"/></td>
		   ...
		   <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><input id="destination" name="destination" type="text" size="30" value="<s:property value='destination'/>"/></td>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">出差概述： </td>
            <td height="20" bgcolor="#FFFFFF" ><input id="title" name="title" type="text" size="30" value="<s:property value='title'/>"/></td>
          </tr> 
          <tr>
