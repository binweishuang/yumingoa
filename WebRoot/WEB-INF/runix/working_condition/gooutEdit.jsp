...
<body >
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">修改外出信息</span></td>
          </tr>
          <tr>
          ...
          <tr> 
            ...
            <td width="38%" height="20" bgcolor="#FFFFFF">
            	<input name="starttime" class="Wdate" id="starttime" type="text" value="<s:date name='starttime' format='yyyy-MM-dd HH:mm:ss'/>" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,maxDate:'#F{$dp.$D(\'endtime\')||\'2020-01-01\'}'})" />
            </td>
          </tr>
          <tr>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">返回时间： </td>
            <td height="20" bgcolor="#FFFFFF"><input name="endtime" class="Wdate" id="endtime" type="text" value="<s:date name='endtime' format='yyyy-MM-dd HH:mm:ss'/>" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true,minDate:'#F{$dp.$D(\'starttime\')}',maxDate:'2020-10-01'})" /></td>
			<td width="12%" height="20" align="right" bgcolor="#f8f8f8">目 的 地： </td>
            <td height="20" bgcolor="#FFFFFF"><input id="destination" name="destination" value="<s:property value='destination'/>" type="text" size="30" /></td>
          </tr> 
		   <tr>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">外出简述： </td>
            <td height="20" bgcolor="#FFFFFF" colspan="3"><input id="title" name="title" type="text" value="<s:property value='title'/>"  size="30" /></td>
          </tr> 
          <tr>
            <td width="12%"  height="20" align="right" bgcolor="#f8f8f8">外出缘由： </td>
            <td width="38%" height="20" colspan="3" bgcolor="#FFFFFF">
            	<textarea id="content" name="content" style="width: 100%;height: 300px"><s:property value='content'/></textarea>
            </td>
          </tr>     
          <tr>
