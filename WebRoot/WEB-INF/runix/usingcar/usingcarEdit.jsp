...
<head>
	...
	<script>
		function doCheck(){
			var usingcarId = document.getElementById('usingcarId').value;
			...
			document.getElementById('usingcarAddForm').action="update.action?usingcarId_q="+usingcarId;
...
<body >
	...
	<s:hidden name="usingcarId" id="usingcarId"></s:hidden>
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="38%" height="20" bgcolor="#FFFFFF">
				<input name="title" id="title" type="text" value="<s:property value='title'/>" size="30"/>
			</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><input name="usingtime" id="usingtime" type="text" value="<s:date name='usingtime' format='yyyy-MM-dd HH:mm:ss'/>" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss'})"  class="Wdate"/></td>
          </tr>
		  <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">返回时间：</td>
            <td height="20" bgcolor="#FFFFFF" ><input name="backtime" id="backtime" type="text" value="<s:date name='backtime' format='yyyy-MM-dd HH:mm:ss'/>" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss'})" size="20"  class="Wdate"/></td>  
            <td height="20" align="right" bgcolor="#f8f8f8">陪同人数：</td>
            <td height="20" bgcolor="#FFFFFF" ><input name="accomnum" id="accomnum" type="text" value="<s:property value='accomnum'/>"  value="" size="20"/></td>                  
          </tr>
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" >
            	<select id="usingproperty" name="usingproperty" style="width:155px">
					...
					<option value="1" <s:if test='usingproperty=="1"'>selected="true"</s:if>>公用</option>
					<option value="2" <s:if test='usingproperty=="2"'>selected="true"</s:if>>私用</option>
				</select>
            </td>  
            ...
            <td height="20" bgcolor="#FFFFFF" >
            	<select id="carId" name="carId" style="width:155px" onchange="selectCar();">
					<option value="">--请选择--</option>
					<s:iterator value="carList" id="st">
				     <option value="<s:property value='#st.carId'/>" <s:if test="#st.carId==carId">selected="true"</s:if>><s:property value='#st.cartype'/>&nbsp;<s:property value='#st.license'/></option>
				    </s:iterator>
				</select>
            </td>                  
          </tr>
           <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" colspan="3">
				<input name="driver" id="driver" type="text" value="<s:property value='driver'/>" size="20" readonly/></td>
          </tr> 
		  <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">用车缘由：</td>
            <td height="160" bgcolor="#FFFFFF" colspan="3"><textarea id='usingreason' style="width:98%;height:100%" name='usingreason'><s:property value='usingreason'/></textarea></td>
          </tr>
          <tr>
