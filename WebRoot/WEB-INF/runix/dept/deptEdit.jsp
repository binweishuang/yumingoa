				...
				<td>
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						<tr>
							...
							<td height="20" bgcolor="#FFFFFF"><input id="deptname"
								name="dept.deptname" type="text" value="${dept.deptname }" size="20"
								maxlength="20" onblur="checkDeptName();" /> <span
						...
						<tr>
							...
							<td height="20" bgcolor="#FFFFFF"><input id="phone"
								name="dept.phone" type="text" value="${dept.phone}" size="20" maxlength="11"
								onblur="checkPhone();" /> <span style="margin-left:10px;"></span>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td height="20" bgcolor="#FFFFFF"><textarea
									name="dept.description" rows="5" cols="50">${dept.description}</textarea>
							</td>
						</tr>
						<tr>
							<td height="20" colspan="4" bgcolor="#FFFFFF"><div
									align="center">
									<input type="button" name="save" value="修改"
										onclick="doEdit();" class="buttons"
										/> 
									<input type="reset" name="cancle"
										value="还原" class="buttons"
										/> 
