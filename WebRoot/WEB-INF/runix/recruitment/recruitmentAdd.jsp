...
<head>
	...
	<script>
		function doCheck(){
			...
			document.getElementById('recruitmentAddForm').action="insert.action";
...
<body >
	...
	<s:hidden name="currentdate"></s:hidden>
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">添加招聘信息</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF">
            	<select id="position" name="position" style="width:155px">
						...
						<option value="<s:property value='postname'/>"><s:property value='postname'/></option>
					</s:iterator>
				</select>
            </td>
            <td height="20" align="right" bgcolor="#f8f8f8">提交人： </td>
            <td height="20" bgcolor="#FFFFFF"><input type="hidden" name="submitter" value="${user.name}" />${user.name}</td>
          </tr>
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">招聘期限： </td>
            <td height="20" bgcolor="#FFFFFF"><input name="limittime" id="limittime" type="text" value="" size="20"/></td>
             <td height="20" align="right" bgcolor="#f8f8f8">招聘人数：</td>
            <td height="20" bgcolor="#FFFFFF" ><input name="peoplenum" id="peoplenum" type="text" value="" size="20"/></td>  
          </tr>         
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">招聘标题：</td>
            <td height="20" bgcolor="#FFFFFF" colspan="3"><input name="title" id="title" type="text" value="" size="30"/></td>    
          </tr>
		  <tr>           
            <td height="20" align="right" bgcolor="#f8f8f8">详细说明：</td>
            <td height="300" bgcolor="#FFFFFF" colspan="3"><textarea id='details' style="width:100%;height:300px" name='details'></textarea></td>
          </tr>
