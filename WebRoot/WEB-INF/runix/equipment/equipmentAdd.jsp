...
<head>
	...
	<script>
		function doCheck(){
			...
			document.getElementById('equipmentAddForm').action="insert.action";
	...
	<s:form action="equipmentAddAction" id="equipmentAddForm" theme="simple"  method="post">
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">添加新设备</span></td>
          </tr>
          <tr>
            ...
            <td width="38%" height="20" bgcolor="#FFFFFF">
				<select id="cateogory" name="cateogory" style="width:155px">
					...
					<s:iterator value="categoryList" id="ca">
					 <option value="<s:property value='#ca.dataId'/>" ><s:property value='#ca.dataname'/></option>
					</s:iterator>
                </select>
			</td>
            ...
            <td width="38%" height="20" bgcolor="#FFFFFF">
                <select id="storage" name="storage" style="width:155px">
					...
					<s:iterator value="storageList" id="st">
				     <option value="<s:property value='#st.dataId'/>" ><s:property value='#st.dataname'/></option>
				    </s:iterator>
				</select>
			</td>
          </tr>
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF">
				<input name="buier" id="buier" onclick="selectPerson();" type="text" value="" size="20" readonly/>
			</td>
            <td height="20" align="right" bgcolor="#f8f8f8">用品名称： </td>
            <td height="20" bgcolor="#FFFFFF">
				<input name="goodsname" id="goodsname" type="text" value="" size="20"/>
			</td>
          </tr>
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">用品数量： </td>
            <td height="20" bgcolor="#FFFFFF"><input name="goodsnum" id="goodsnum" type="text" value="" size="20"/></td>
            <td height="20" align="right" bgcolor="#f8f8f8">用品单价：</td>
            <td height="20" bgcolor="#FFFFFF"><input name="unitprice" id="unitprice" type="text" value="" size="20"/> 元</td>
          </tr>         
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">维修数量：</td>
            <td height="20" bgcolor="#FFFFFF"><input name="repairnum" id="repairnum" type="text" value="" size="20"/></td>
            <td height="20" align="right" bgcolor="#f8f8f8">报废数量：</td>
            <td height="20" bgcolor="#FFFFFF"><input name="scrapnum" id="scrapnum" type="text" value="" size="20" /></td>
          </tr>
		  <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">计量单位：</td>
            <td height="20" bgcolor="#FFFFFF" colspan="3"><input name="measureunit" id="measureunit" type="text" value="" size="20"/></td>          
          </tr>
		  <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">备注：</td>
            <td height="260" bgcolor="#FFFFFF" colspan="3"><textarea id='remark' style="width:98%;height:100%" name='remark'></textarea></td>
          </tr>
