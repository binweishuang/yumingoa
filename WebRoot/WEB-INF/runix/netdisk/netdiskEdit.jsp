...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	...
	<div id="errorMessage_div" style="color:red;background: #FFEFD5;border:0px solid #FFDAB9;border-collapse: collapse;">
		...
		<s:form id="netdiskForm" action="netdiskAction" theme="simple">
		...
		<table  class="right01" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="right02_td">
					<div class="titlebt">
						<s:if test="#readonly == false"><s:text name="netdisk.insert"/></s:if>
						<s:elseif test="#readonly == true"><s:text name="netdisk.update"/></s:elseif>
					</div>
					<ul class="maincon">
					...
					<div id="main_content1">
						...
						<div>
							<table class="base_table">
								...
								<tr>
									<td class="base_tR"><s:text name="netdisk.filename"/>:</td>
									<td><s:textfield name="filename" cssClass="search_txt01"/></td>

									<td class="base_tR"><s:text name="netdisk.filesize"/>:</td>
									<td><s:textfield name="filesize" cssClass="search_txt01"/></td>

								</tr>
								<tr>
									<td class="base_tR"><s:text name="netdisk.filepath"/>:</td>
									<td><s:textfield name="filepath" cssClass="search_txt01"/></td>

									<td class="base_tR"><s:text name="netdisk.uploadtime"/>:</td>
									<td><s:textfield name="uploadtime" cssClass="search_txt01"/></td>

								</tr>
								<tr>
									<td class="base_tR"><s:text name="netdisk.publicity"/>:</td>
									<td><s:textfield name="publicity" cssClass="search_txt01"/></td>

									<td class="base_tR"><s:text name="netdisk.folderId"/>:</td>
									<td><s:textfield name="folderId" cssClass="search_txt01"/></td>

								</tr>
								<tr>
									<td class="base_tR"><s:text name="netdisk.uploader"/>:</td>
									<td><s:textfield name="uploader" cssClass="search_txt01"/></td>

									<td class="base_tR"><s:text name="netdisk.flag"/>:</td>
