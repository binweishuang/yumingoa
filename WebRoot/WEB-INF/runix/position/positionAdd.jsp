...
<body >
      ...
      <form name="form" id="form" action="addPosition.action" method="post">
      <table width="100%" border="0" cellspacing="0" cellpadding="5">
       <tr>
        <td>
	        <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td height="25" background="<%=SystemConfig.FRAMEWORK_PATH%>/img/bg-tit.jpg">&nbsp;&nbsp;当前位置： 系统管理 &gt;&gt; <span class="STYLE1">职位管理</span>&nbsp;&gt;&gt; <span class="STYLE1">新建职位</span></td>
					  </tr>
					</table>		  
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="2" align="center" bgcolor="#FEF3D5"><span class="STYLE1">新建职位</span></td>
          </tr>
          <tr>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">职位名称： </td>
            <td height="20" bgcolor="#FFFFFF">
            	<input name="position.postname" id="pname" type="text" size="20" onBlur="checkName();"/>
            </td>
          </tr>
          <tr>
            <td width="12% height="20" align="right" bgcolor="#f8f8f8">是否屏蔽： </td>
            <td height="20" bgcolor="#FFFFFF" align="left">
				是：<input name="position.screen" type="radio"  value="1"/>
				否：<input name="position.screen" type="radio"  value="0" checked="checked"/>
			</td>
          </tr>                  
          <tr>
            <td width="12%  height="20" align="right" bgcolor="#f8f8f8">职位描述： </td>
            <td height="20" colspan="3" bgcolor="#FFFFFF">
            	<textarea name="position.description" cols ="50" rows = "5"></textarea>
            </td>
          </tr>     
          <tr>
