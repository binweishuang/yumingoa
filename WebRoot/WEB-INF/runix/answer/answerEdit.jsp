...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	...
	<div id="errorMessage_div" style="color:red;background: #FFEFD5;border:0px solid #FFDAB9;border-collapse: collapse;">
		...
		<s:form id="answerForm" action="answerAction" theme="simple">
		...
		<table  class="right01" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="right02_td">
					<div class="titlebt">
						<s:if test="#readonly == false"><s:text name="answer.insert"/></s:if>
						<s:elseif test="#readonly == true"><s:text name="answer.update"/></s:elseif>
					</div>
					<ul class="maincon">
					...
					<div id="main_content1">
						...
						<div>
							<table class="base_table">
								...
								<tr>
									<td class="base_tR"><s:text name="answer.sortnum"/>:</td>
									<td><s:textfield name="sortnum" cssClass="search_txt01"/></td>

									<td class="base_tR"><s:text name="answer.content"/>:</td>
									<td><s:textfield name="content" cssClass="search_txt01"/></td>

								</tr>
								<tr>
									<td class="base_tR"><s:text name="answer.uservotenum"/>:</td>
									<td><s:textfield name="uservotenum" cssClass="search_txt01"/></td>

									<td class="base_tR"><s:text name="answer.surveyId"/>:</td>
									<td><s:textfield name="surveyId" cssClass="search_txt01"/></td>

								</tr>
								<tr>
									<td class="base_tR"><s:text name="answer.flag"/>:</td>
