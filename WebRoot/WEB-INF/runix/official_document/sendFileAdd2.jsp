...
<head>
	...
	function doCheck(){
		...
		document.getElementById('sendFileAddForm').action='insertPerson.action';
		document.getElementById('sendFileAddForm').submit();
	}
	</script>
</head>
<body >
	<s:form action="sendFileAddAction" id="sendFileAddForm" theme="simple"  method="post">
	<s:hidden name="documentId"></s:hidden>
	...
	<s:hidden name="flag" id="flag"></s:hidden>
       ...
       <tr>
        <td>
		  ...
		  <tr>
			<td height="25" background="<%=SystemConfig.FRAMEWORK_PATH%>/img/bg-tit.jpg">&nbsp;&nbsp;当前位置： 公文管理 &gt;&gt; <span class="STYLE1">发文管理</span>&gt;&gt; <span class="STYLE1">发文登记</span></td>
		  </tr>
		</table>		  
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="88%" height="20" bgcolor="#FFFFFF">发文管理
			</td>
          </tr>
          <tr>
