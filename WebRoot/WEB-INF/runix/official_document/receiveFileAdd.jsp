  ...
  <s:hidden name="flag" id="flag"></s:hidden>
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">登记收文</span></td>
          </tr>
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><input name="company" id="company" type="text"  value="" size="30"/></td>
		  ...
		  <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><input name="receivenum" id="receivenum" type="text" value="" size="20" /></td>
		   ...
		   <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" colspan="3"><input name="receivedate" id="receivedate" type="text" value="" size="20" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd',vel:'smonth',realDateFmt:'yyyy-MM-dd'})" class="Wdate"/></td>
          </tr>  
		  <tr>
