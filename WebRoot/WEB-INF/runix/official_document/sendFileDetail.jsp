...
<body >
   <s:form action="sendFileAction" id="sendFileDetailForm" theme="simple"  method="post" >
       ...
       <tr>
        <td>
	        <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td height="25" background="<%=SystemConfig.FRAMEWORK_PATH%>/img/bg-tit.jpg">&nbsp;&nbsp;当前位置： 公文管理 &gt;&gt; <span class="STYLE1">发文管理</span>&gt;&gt; <span class="STYLE1">查看发文</span></td>
					  </tr>
					</table>		  
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
		  ...
		  <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" colspan="3" ><s:if test='checkstatus=="1"'>已审核</s:if><s:elseif test='checkstatus=="2"'>审核中</s:elseif><s:elseif test='checkstatus=="3"'>未审核</s:elseif></td>
          </tr>
		  <tr>
