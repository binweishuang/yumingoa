       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><input name="mainsender" id="mainsender" type="text" value="<s:property value='mainsender'/>" size="20"/></td>
            <td height="20" align="right" bgcolor="#f8f8f8">抄送者：</td>
            <td height="20" bgcolor="#FFFFFF"><input name="copysender" id="copysender" type="text" value="<s:property value='copysender'/>" size="20"/></td>
          </tr>   
          <tr>
		  ...
		  <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><input name="timelimit" id="timelimit" type="text" value="<s:property value='timelimit'/>" onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy',vel:'smonth',realDateFmt:'yyyy'})" size="20" class="Wdate" /></td>
