...
<head>
	...
	function doCheck(){
		...
		document.getElementById('receiveFileAddForm').action='insertPerson.action';
		document.getElementById('receiveFileAddForm').submit();
	}
	</script>
</head>
<body >
	<s:form action="receiveFileAddAction" id="receiveFileAddForm" theme="simple"  method="post">
       ...
       <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="88%" height="20" bgcolor="#FFFFFF">收文管理
			</td>
          </tr>
          <tr>
