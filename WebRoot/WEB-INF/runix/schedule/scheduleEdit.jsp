        ...
        <td>
	        <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						...
						<span class="STYLE1">修改日程</span></td>
					  </tr>
					</table>		  
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="26" colspan="4" align="center" bgcolor="#FEF3D5"><span class="STYLE1">修改日程</span></td>
          </tr>
          <tr>
            <td width="12%" height="20" align="right" bgcolor="#f8f8f8">日程标题： </td>
            <td height="20" bgcolor="#FFFFFF">
            	<input name="schedule.title" id="title" type="text"  value="${schedule.title }" size="20" onblur="Check();"/>
		  ...
		  <tr>
            ...
            <td height="20" bgcolor="#FFFFFF">${schedule.executer }<input type="hidden" name="schedule.executer" value="${schedule.executer }"/></td>
          </tr> 
          <tr>
            <td height="20" align="right" bgcolor="#f8f8f8">时间： </td>
            <td height="20" bgcolor="#FFFFFF">
				<input name="schedule.starttime" id="start" type="text"  value="<s:property value="@runix.util.StringUtil@dateFmt(schedule.starttime)"/>" size="20" 
					onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false,readOnly:true,maxDate:'#F{$dp.$D(\'endDate\')||\'2020-01-01\'}'})" class="Wdate"/>
				至
				<input name="schedule.endtime" id="endDate" type="text" value="<s:property value="@runix.util.StringUtil@dateFmt(schedule.endtime)"/>" size="20"  
					onclick="WdatePicker({autoPickDate:true,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',vel:'smonth',realDateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false,readOnly:true,minDate:'#F{$dp.$D(\'start\')}',maxDate:'2020-10-01'})" class="Wdate"/>
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF">
				<textarea name="schedule.content" id="content"  style="width:98%;height:200px;">${schedule.content}</textarea><span id="contentErr"></span>
			</td>
          </tr>     
          <tr>
