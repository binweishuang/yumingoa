 ...
 * 最后修正：2013-04-08
 **/
var IMAGESPATH = '/oa/images/images/'; //图片路径配置
...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table class="dialog" id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="33" style="background-image: url(' + IMAGESPATH + 'dialog_lt.png) no-repeat right 0 !important;background: url(' + IMAGESPATH + 'dialog_lt.gif) no-repeat right 0;"><div style="width: 13px;"></div></td>\
      ...
      <td width="13" height="33" style="background-image: url(' + IMAGESPATH + 'dialog_rt.png) no-repeat left 0 !important;background: url(' + IMAGESPATH + 'dialog_rt.gif) no-repeat left 0;"><div style="width: 13px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="13" style="background-image: url(' + IMAGESPATH + 'dialog_mlm.png) !important;background: url(' + IMAGESPATH + 'dialog_mlm.gif) repeat-y right;"></td>\
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
                <img src="' + IMAGESPATH + 'qd.gif"  value="确 定" style="cursor:pointer" onfocus="this.blur();" id="_ButtonOK_' + this.ID + '"/>\
                <img src="' + IMAGESPATH + 'qx.gif"  value="取 消" style="cursor:pointer" onfocus="this.blur();" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
      <td width="13" style="background-image: url(' + IMAGESPATH + 'dialog_mrm.png) repeat-y left 0  !important;background: url(' + IMAGESPATH + 'dialog_mrm.gif) repeat-y left;"></td>\
    </tr>\
    <tr>\
      <td width="13" height="13" style="background-image: url(' + IMAGESPATH + 'dialog_lb.png) !important;background: url(' + IMAGESPATH + 'dialog_lb.gif) no-repeat right bottom;"></td>\
      ...
      <td width="13" height="13" style="background-image: url(' + IMAGESPATH + 'dialog_rb.png) !important;background: url(' + IMAGESPATH + 'dialog_rb.gif) no-repeat left bottom;"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
'
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.okButton.style.cursor= "pointer";
    //diag.okButton.focus();
...
Dialog.confirm = function (msg, funcOK, funcCal, w, h) {
    ...
    diag.okButton.parentNode.style.textAlign = "center";
    diag.okButton.style.cursor= "pointer";
    diag.cancelButton.style.cursor= "pointer";
    diag.okButton.focus();
};
