...
// instead.
var ValidationRoot = getSysResourcesPath()+"/js/JSValidation/";
...
ValidationFramework.validateForm = function(fform) {
	...
	if (errorStrArray.length > 0) {
		if (showError == "alert") {
			if (showType == "first") {
				Ext.MessageBox.alert("警告",errorStrArray[0]);
				//alert(errorStrArray[0]);
			} else {
				Ext.MessageBox.alert("警告",errorStrArray.join(br));
