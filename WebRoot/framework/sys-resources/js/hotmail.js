...
bSearch = false;var L_SignInAB_Text="登录"


var L_SignInABcont_Text="登录"
var L_IsOnline_Text="联机"
var L_IsOffline_Text="脱机"
var L_IsBusy_Text= "忙碌"
var L_IsAway_Text="离开"
var L_IsBRB_Text="马上回来"
var L_IsOnThePhone_Text="接听电话"
var L_IsOutToLunch_Text="外出就餐"
var L_UseWithMSNmessenger_Text="使用 MSN Messenger"
var L_DloadMess_Text="下载 MSN Messenger"
var L_DloadMessCont_Text="查看谁已联机、交换即时消息以及更多内容。"
...
if (loc=="InBox")
ret='<A HREF="JavaScript:MIM(%22' + eM + '%22)"><IMG alt="" src="http://65.54.172.24/icon_messenger'+img+'.gif" border=0></a>';
else if (loc=="AddressBookList")
{
if (CS==1)
ret='&nbsp;&nbsp;&nbsp;<A href="#" onclick="DC();return false;"><IMG alt="" src="http://65.54.172.24/icon_messenger'+img+'.gif" border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
else
ret='&nbsp;&nbsp;&nbsp;<A HREF="JavaScript:MIM(%22' + eM + '%22)"><IMG alt="" src="http://65.54.172.24/icon_messenger'+img+'.gif" border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;';
}
return ret;
...
CA(1);  
var DTa=document.all.ListTable;
DTa.rows[0].cells[0].innerHTML="<a href=''>"+L_DloadMess_Text+"</a>"+L_DloadMessCont_Text;
}
function MIB()
{
CA(1); 
...
DC.onmouseover=OMO;
DC.onmouseout=OMOU;
DC.innerHTML='<img src="http://65.54.172.24/i.p.instantreply.gif" border=0 align="absmiddle" hspace="1"> 立即答复';
}
}
function IR()
...
{
	qF=H;
	document.ToInd.src = document.CcInd.src = document.BccInd.src = 'http://65.54.172.24/spacer.gif';
	if (H=="to")
	document.ToInd.src = 'http://65.54.172.24/i.p.toarrow.gif';
	if (H=="cc")
	document.CcInd.src ='http://65.54.172.24/i.p.toarrow.gif';
	if (H=="bcc")
	document.BccInd.src = 'http://65.54.172.24/i.p.toarrow.gif';
}
	function MIT(qaName){
...
NotBulkButton.children[0].src="http://65.54.172.24/i.p.notjunk.d.gif";
...
NotBulkButton.children[0].src="http://65.54.172.24/i.p.notjunk.gif";
...
NotBulkButton.children[0].src=(TO>1)?"http://65.54.172.24/i.p.notjunk.d.gif":"http://65.54.172.24/i.p.notjunk.gif";
...
function HM(l){
	//SORT 邮件
	//l是参数串，例如sort=subject
	document.location = "mail_inbox.aspx?"+l+"&"+_UM;
}
function HMFO(f){
	//打开指定的文件夹
	if(f==""){
	...
	document.location = "mail_inbox.aspx?mb="+f
}

function MoveMailTo(targetFolderID){
	alert('邮件转移到'+ targetFolderID + '\nTODO');
}
