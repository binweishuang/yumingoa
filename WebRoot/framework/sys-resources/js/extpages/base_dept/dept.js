...
//		mode : "local",
	...
	addFormPanel.superclass.constructor.call(this, {
		...
		items : [this.deptid, this.deptname, this.companyid, this.phone,this.deptno]
	});
}
/**
...
var editFormPanel = function() {
	...
	editFormPanel.superclass.constructor.call(this, {
		...
		reader : new Ext.data.JsonReader({
			...
			totalProperty : 'totalProperty',
			id : 'deptid'
		}, ['deptid', 'deptname', 'companyid', 'phone', 'deptno']),
		items : [this.deptid, this.deptname, this.companyid, this.phone, this.deptno]
	});
}
/**
...
/*------------------开始查询使用的表单和查询方法-------------------*/
var deptid_q = new Ext.form.TextField({
	name : 'deptid_q',
	width : 80
});

var deptname_q = new Ext.form.TextField({
	name : 'deptname_q',
	width : 80
});
...
function doSelect() {
	...
	var deptname = deptname_q.getValue();
...
var myGridPanel = function() {
	...
	this.store.on("beforeload",function(t){
        t.baseParams = {
            ...
            deptname_q : deptname_q.getValue(),
				...
				'-',
				{
					...
					handler : function() {
						...
						if (record != null) {
							...
							editWin.loadData(record.data.deptid);
