package kdf.chart.singleSeries.pie2D;

import java.util.Iterator;
import java.util.List;

import kdf.chart.singleSeries.pie2D.chart.ChartCosmetics;
import kdf.chart.singleSeries.pie2D.chart.ChartPadding;
import kdf.chart.singleSeries.pie2D.chart.ChartTitles;
import kdf.chart.singleSeries.pie2D.chart.FunctionalAttributes;
import kdf.chart.singleSeries.pie2D.chart.Tooltip;
import kdf.chart.singleSeries.pie2D.data.DataPlotCosmetics;
import kdf.chart.singleSeries.pie2D.data.PieProperties;
import kdf.chart.singleSeries.pie2D.data.Set;
import kdf.chart.singleSeries.pie2D.data.SmartLines;
import kdf.chart.singleSeries.pie2D.others.FontProperties;
import kdf.chart.singleSeries.pie2D.others.NumberFormatting;
...
public class PlanPie2DChart {
	...
	public PlanPie2DChart(FunctionalAttributes functionalAttributes,
	...
	public Document buildXml(List datas) {
		...
		if(null!=pieProperties) {
			if(null!=pieProperties.getRadius3D()) 
				chart.addAttribute("radius3D",CommonMethod.convertDoubleToString(pieProperties.getRadius3D()));
		...
		if(null!=datas&&0<datas.size()) {
			for(Iterator iter = datas.iterator();iter.hasNext();) {	
				...
				if(null!=setobj.getBorderAlpha())
					set.addAttribute("borderAlpha", setobj.getBorderAlpha());
