package kdf.chart.singleSeries.area;

import java.util.Iterator;
import java.util.List;

import kdf.chart.singleSeries.area.chart.Anchors;
import kdf.chart.singleSeries.area.chart.ChartCosmetics;
import kdf.chart.singleSeries.area.chart.ChartPadding;
import kdf.chart.singleSeries.area.chart.ChartTitles;
import kdf.chart.singleSeries.area.chart.DivisionalLines;
import kdf.chart.singleSeries.area.chart.FunctionalAttributes;
import kdf.chart.singleSeries.area.chart.Tooltip;
import kdf.chart.singleSeries.area.data.DataPlotCosmetics;
import kdf.chart.singleSeries.area.data.Set;
import kdf.chart.singleSeries.area.others.FontProperties;
import kdf.chart.singleSeries.area.others.NumberFormatting;
import kdf.chart.singleSeries.area.others.TrendLines;
import kdf.chart.singleSeries.area.others.VerticalLines;
...
public class PlanAreaChart {
	...
	public PlanAreaChart(FunctionalAttributes functionalAttributes,
	...
	public Document buildXml(List datas) {
		...
		if(null!=dataPlotCosmetics) {
			...
			if(null!=dataPlotCosmetics.getPlotFillColor()) 
				chart.addAttribute("plotFillColor",dataPlotCosmetics.getPlotFillColor());
		}
		//anchors
		if(null!=anchors) {
