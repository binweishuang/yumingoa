package kdf.chart.scroll.scrollCombiDY2D;

import java.util.Iterator;
import java.util.List;

import kdf.chart.scroll.scrollCombiDY2D.chart.Anchors;
import kdf.chart.scroll.scrollCombiDY2D.chart.ChartCosmetics;
import kdf.chart.scroll.scrollCombiDY2D.chart.ChartPadding;
import kdf.chart.scroll.scrollCombiDY2D.chart.ChartTitles;
import kdf.chart.scroll.scrollCombiDY2D.chart.DivisionalLines;
import kdf.chart.scroll.scrollCombiDY2D.chart.FunctionalAttributes;
import kdf.chart.scroll.scrollCombiDY2D.chart.Legend;
import kdf.chart.scroll.scrollCombiDY2D.chart.ScrollProperties;
import kdf.chart.scroll.scrollCombiDY2D.chart.Tooltip;
import kdf.chart.scroll.scrollCombiDY2D.data.Categories;
import kdf.chart.scroll.scrollCombiDY2D.data.Category;
import kdf.chart.scroll.scrollCombiDY2D.data.DataPlotCosmetics;
import kdf.chart.scroll.scrollCombiDY2D.data.Dataset;
import kdf.chart.scroll.scrollCombiDY2D.data.Set;
import kdf.chart.scroll.scrollCombiDY2D.others.FontProperties;
import kdf.chart.scroll.scrollCombiDY2D.others.NumberFormatting;
import kdf.chart.scroll.scrollCombiDY2D.others.TrendLines;
import kdf.chart.scroll.scrollCombiDY2D.others.VerticalLines;
...
public class PlanScrollCombiDY2DChart {
	...
	public PlanScrollCombiDY2DChart() {
		...
		functionalAttributes.setNumVisiblePlot(new Integer(5));
	...
	public PlanScrollCombiDY2DChart(FunctionalAttributes functionalAttributes,
			ChartTitles chartTitles, ChartCosmetics chartCosmetics,
			ScrollProperties scrollProperties, Anchors anchors,
	...
	public Document buildXml(List datas) {
		...
		if(null!=functionalAttributes) {
			if(null!=functionalAttributes.getNumVisiblePlot()) 
				chart.addAttribute("numVisiblePlot", CommonMethod.convertIntegerToString(functionalAttributes.getNumVisiblePlot()));
			...
			if(null!=functionalAttributes.getScrollToEnd()) 
				chart.addAttribute("scrollToEnd",CommonMethod.convertBooleanToString(functionalAttributes.getScrollToEnd()));
		}
		//chartTitles
		if(null!=chartTitles) {
		...
		//scrollProperties
		if(null!=scrollProperties) {
			if(null!=scrollProperties.getScrollColor()) 
				chart.addAttribute("scrollColor",scrollProperties.getScrollColor());
			if(null!=scrollProperties.getScrollHeight()) 
				chart.addAttribute("scrollHeight",CommonMethod.convertIntegerToString(scrollProperties.getScrollHeight()));
			if(null!=scrollProperties.getScrollPadding()) 
				chart.addAttribute("scrollPadding",CommonMethod.convertIntegerToString(scrollProperties.getScrollPadding()));
			if(null!=scrollProperties.getScrollBtnWidth()) 
				chart.addAttribute("scrollBtnWidth",CommonMethod.convertIntegerToString(scrollProperties.getScrollBtnWidth()));
			if(null!=scrollProperties.getScrollBtnPadding()) 
				chart.addAttribute("scrollBtnPadding",CommonMethod.convertIntegerToString(scrollProperties.getScrollBtnPadding()));
		}
		//anchors
		if(null!=anchors) {
	...
	public ScrollProperties getScrollProperties() {
		return scrollProperties;
	}

	public void setScrollProperties(ScrollProperties scrollProperties) {
		this.scrollProperties = scrollProperties;
	}
