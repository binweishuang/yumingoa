...
public class DivisionalLines {
	...
	private Boolean divLineDecimalPrecision;
	...
	public DivisionalLines() {
		...
		this.divLineDecimalPrecision = null;
	}
	...
	public DivisionalLines(Integer numDivLines, String divLineColor,
			...
			Integer alternateHGridAlpha, Boolean divLineDecimalPrecision) {
		super();
	...
	public Boolean getDivLineDecimalPrecision() {
		return divLineDecimalPrecision;
	}

	public void setDivLineDecimalPrecision(Boolean divLineDecimalPrecision) {
		this.divLineDecimalPrecision = divLineDecimalPrecision;
	}
