package kdf.chart.multiSeries.column2D;

import java.util.Iterator;
import java.util.List;

import kdf.chart.multiSeries.column2D.chart.ChartCosmetics;
import kdf.chart.multiSeries.column2D.chart.ChartPadding;
import kdf.chart.multiSeries.column2D.chart.ChartTitles;
import kdf.chart.multiSeries.column2D.chart.DivisionalLines;
import kdf.chart.multiSeries.column2D.chart.FunctionalAttributes;
import kdf.chart.multiSeries.column2D.chart.Legend;
import kdf.chart.multiSeries.column2D.chart.Tooltip;
import kdf.chart.multiSeries.column2D.data.Categories;
import kdf.chart.multiSeries.column2D.data.Category;
import kdf.chart.multiSeries.column2D.data.DataPlotCosmetics;
import kdf.chart.multiSeries.column2D.data.Dataset;
import kdf.chart.multiSeries.column2D.data.Set;
import kdf.chart.multiSeries.column2D.others.FontProperties;
import kdf.chart.multiSeries.column2D.others.NumberFormatting;
import kdf.chart.multiSeries.column2D.others.TrendLines;
import kdf.chart.multiSeries.column2D.others.VerticalLines;
...
public class PlanColumn2DChart {
	...
	public PlanColumn2DChart() {
		...
		dataPlotCosmetics.setUseRoundEdges(new Boolean(true));
	...
	public PlanColumn2DChart(FunctionalAttributes functionalAttributes,
	...
	public Document buildXml(List datas) {
		...
		if(null!=dataPlotCosmetics) {
			...
			if(null!=dataPlotCosmetics.getPlotFillRatio()) 
				chart.addAttribute("plotFillRatio",CommonMethod.convertIntegerToString(dataPlotCosmetics.getPlotFillRatio()));
