package kdf.chart.multiSeries.line.chart;
...
public class ChartCosmetics {
	...
	public ChartCosmetics() {
		...
		this.canvasBgRatio = null;
		this.canvasBgAngle = null;
		this.canvasBorderColor = null;
		this.canvasBorderThickness = null;
		this.canvasBorderAlpha = null;
	...
	public ChartCosmetics(String bgColor, String bgAlpha, String bgRatio,
			...
			String canvasBgColor, Integer canvasBgAlpha, Integer canvasBgRatio,
			Integer canvasBgAngle, String canvasBorderColor,
			Integer canvasBorderThickness, Integer canvasBorderAlpha,
