...
public class FunctionalAttributes {
	...
	public FunctionalAttributes(Boolean animation, Integer palette,
			...
			Boolean connectNullData, Boolean showYAxisValues,
			Boolean showLimits, Boolean showDivLineValues,
			Integer axisValuesStep, Boolean showShadow, Boolean adjustDiv,
			Boolean rotateYAxisName, Integer axisNameWidth, String clickURL,
			Boolean defaultAnimation, Integer axisMinValue,
			Integer axisMaxValue, Boolean setAdaptiveYMin,Integer shadowAlpha) {
		super();
