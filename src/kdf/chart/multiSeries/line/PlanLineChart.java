package kdf.chart.multiSeries.line;

import java.util.Iterator;
import java.util.List;

import kdf.chart.multiSeries.line.chart.Anchors;
import kdf.chart.multiSeries.line.chart.ChartCosmetics;
import kdf.chart.multiSeries.line.chart.ChartPadding;
import kdf.chart.multiSeries.line.chart.ChartTitles;
import kdf.chart.multiSeries.line.chart.DivisionalLines;
import kdf.chart.multiSeries.line.chart.FunctionalAttributes;
import kdf.chart.multiSeries.line.chart.Legend;
import kdf.chart.multiSeries.line.chart.Tooltip;
import kdf.chart.multiSeries.line.data.Categories;
import kdf.chart.multiSeries.line.data.Category;
import kdf.chart.multiSeries.line.data.DataPlotCosmetics;
import kdf.chart.multiSeries.line.data.Dataset;
import kdf.chart.multiSeries.line.data.Set;
import kdf.chart.multiSeries.line.others.FontProperties;
import kdf.chart.multiSeries.line.others.NumberFormatting;
import kdf.chart.multiSeries.line.others.TrendLines;
import kdf.chart.multiSeries.line.others.VerticalLines;
...
//		functionalAttributes.setShadowAlpha(new Integer(40));
		
		chartCosmetics = new ChartCosmetics();
		chartCosmetics.setBgColor("FFFFFF,CC3300");
		chartCosmetics.setBgAngle(new Integer(270));
		chartCosmetics.setBgAlpha("10,10");
		
		chartPadding = new ChartPadding();
		chartPadding.setChartRightMargin(new Integer(35));
		...
		divisionalLines.setDivLineColor("CC3300");
		divisionalLines.setVDivLineColor("CC3300");
		divisionalLines.setDivLineAlpha(new Integer(20));
		divisionalLines.setVDivLineAlpha(new Integer(20));
		divisionalLines.setDivLineIsDashed(new Boolean(true));
		divisionalLines.setVDivLineIsDashed(new Boolean(true));
		divisionalLines.setShowAlternateHGridColor(new Boolean(true));
		divisionalLines.setShowAlternateVGridColor(new Boolean(true));
		divisionalLines.setAlternateHGridAlpha(new Integer(5));
		divisionalLines.setAlternateVGridAlpha(new Integer(5));
		divisionalLines.setAlternateHGridColor("CC3300");
		divisionalLines.setAlternateVGridColor("CC3300");
		divisionalLines.setNumDivLines(new Integer(5));
		divisionalLines.setNumVDivLines(new Integer(5));
		...
		legend = null;
		anchors = new Anchors();		
		anchors.setAnchorRadius(new Integer(2));
		
		dataPlotCosmetics = new DataPlotCosmetics();
		dataPlotCosmetics.setLineThickness(new Integer(1));
	}
	...
	public PlanLineChart(FunctionalAttributes functionalAttributes,
			...
			TrendLines trendLines, Anchors anchors, Legend legend) {
		super();
	...
	public Document buildXml(List datas) {
		...
		if(null!=functionalAttributes) {
			...
			if(null!=functionalAttributes.getShadowAlpha()) 
				chart.addAttribute("shadowAlpha", CommonMethod.convertIntegerToString(functionalAttributes.getShadowAlpha()));
		}
		//chartTitles
		if(null!=chartTitles) {
